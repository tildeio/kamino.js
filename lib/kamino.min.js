...
b+=d;a++}if('"'==g[a])return a++,b;h()}function h(){a=r=y;throw SyntaxError();}function F(b,a,c,d,f,p,A){var e=a[b],j,n,h,i,l,q,r,v,x,k,z;k="";if(e instanceof Error||e instanceof Function)throw new KaminoException;if(this.Element&&e instanceof Element)throw new KaminoException;if("object"==typeof e&&e)if(j=m.call(e),"[object Date]"==j&&!o.call(e,"toJSON"))if(e>-1/0&&e<1/0){if(B){i=t(e/864E5);for(n=t(i/365.2425)+1970-1;B(n+1,0)<=i;n++);for(h=t((i-B(n,0))/30.42);B(n,h+1)<=i;h++);i=1+i-B(n,h);l=(e%864E5+
864E5)%864E5;q=t(l/36E5)%24;r=t(l/6E4)%60;v=t(l/1E3)%60;l%=1E3}else n=e.getUTCFullYear(),h=e.getUTCMonth(),i=e.getUTCDate(),q=e.getUTCHours(),r=e.getUTCMinutes(),v=e.getUTCSeconds(),l=e.getUTCMilliseconds();e=(0>=n||1E4<=n?(0>n?"-":"+")+u(6,0>n?-n:n):u(4,n))+"-"+u(2,h+1)+"-"+u(2,i)+"T"+u(2,q)+":"+u(2,r)+":"+u(2,v)+"."+u(3,l)+"Z"}else e=y;else if("function"==typeof e.toJSON&&("[object Number]"!=j&&"[object String]"!=j&&"[object Array]"!=j||o.call(e,"toJSON")))e=e.toJSON(b);c&&(e=c.call(a,b,e));if(e===
y)return"null";if(void 0!==e){b=m.call(e);if("[object Boolean]"==b)return""+e;if("[object Number]"==b)return e===Number.POSITIVE_INFINITY?"Infinity":e===Number.NEGATIVE_INFINITY?"NInfinity":isNaN(e)?"NaN":""+e;if("[object RegExp]"==b)return j=e.source,k+=e.ignoreCase?"i":"",k+=e.global?"g":"",k+=e.multiline?"m":"",j=C(w?j.split(""):j),k=C(w?k.split(""):k),e="^"+j+k;if("[object String]"==b)return e=C(w?e.split(""):e),"[object Date]"==j&&(e="%"+e),e;if("object"==typeof e){for(k=A.length;k--;)if(A[k]===
e)return"&"+k;A.push(e);x=[];j=p;p+=f;if("[object Array]"==b){a=0;for(k=e.length;a<k;z||(z=s),a++)b=F(a,e,c,d,f,p,A),x.push(void 0===b?"null":b);k=z?f?"[\n"+p+x.join(",\n"+p)+"\n"+j+"]":"["+x.join(",")+"]":"[]"}else D(d||e,function(b){var a=F(b,e,c,d,f,p,A);void 0!==a&&x.push(C(w?b.split(""):b)+":"+(f?" ":"")+a);z||(z=s)}),k=z?f?"{\n"+p+x.join(",\n"+p)+"\n"+j+"}":"{"+x.join(",")+"}":"{}";return k}}}function C(b){for(var a='"',c=0,d;d=b[c];c++)a+=-1<'\\"\u0008\u000c\n\r\t'.indexOf(d)?I[d]:I[d]=" ">
d?"\\u00"+u(2,d.charCodeAt(0).toString(16)):d;return a+'"'}function u(b,a){return("000000"+(a||0)).slice(-b)}var m={}.toString,o,D;Kamino={};"undefined"!==typeof exports?("undefined"!==typeof module&&module.a&&(exports=module.a=Kamino),exports.c=Kamino):i.Kamino=Kamino;Kamino.VERSION="0.1.0";KaminoException=function(){this.name="KaminoException";this.message="Uncaught Error: DATA_CLONE_ERR: Kamino Exception 25"};i=new Date(-3509827334573292);try{i=-109252==i.getUTCFullYear()&&0===i.getUTCMonth()&&
1==i.getUTCDate()&&10==i.getUTCHours()&&37==i.getUTCMinutes()&&6==i.getUTCSeconds()&&708==i.getUTCMilliseconds()}catch(M){}var w="A"!="A"[0];if(!i)var t=Math.floor,L=[0,31,59,90,120,151,181,212,243,273,304,334],B=function(b,a){return L[a]+365*(b-1970)+t((b-1969+(a=+(a>1)))/4)-t((b-1901+a)/100)+t((b-1601+a)/400)};if(!(o={}.hasOwnProperty))o=function(a){var g={},c;if((g.__proto__=y,g.__proto__={toString:1},g).toString!=m)o=function(a){var b=this.__proto__,a=a in(this.__proto__=y,this);this.__proto__=
b;return a};else{c=g.constructor;o=function(a){var b=(this.constructor||c).prototype;return a in this&&!(a in b&&this[a]===b[a])}}g=y;return o.call(this,a)};D=function(a,g){var c=0,d,f,h;(d=function(){this.valueOf=0}).prototype.valueOf=0;f=new d;for(h in f)o.call(f,h)&&c++;d=f=y;if(c)c=c==2?function(a,b){var c={},d=m.call(a)=="[object Function]",f;for(f in a)!(d&&f=="prototype")&&!o.call(c,f)&&(c[f]=1)&&o.call(a,f)&&b(f)}:function(a,b){var c=m.call(a)=="[object Function]",d,f;for(d in a)!(c&&d=="prototype")&&
o.call(a,d)&&!(f=d==="constructor")&&b(d);(f||o.call(a,d="constructor"))&&b(d)};else{f=["valueOf","toString","toLocaleString","propertyIsEnumerable","isPrototypeOf","hasOwnProperty","constructor"];c=function(a,b){var c=m.call(a)=="[object Function]",d;for(d in a)!(c&&d=="prototype")&&o.call(a,d)&&b(d);for(c=f.length;d=f[--c];o.call(a,d)&&b(d));}}c(a,g)};var I={"\\":"\\\\",'"':'\\"',"\u0008":"\\b","\u000c":"\\f","\n":"\\n","\r":"\\r","\t":"\\t"};Kamino.stringify=function(a,g,c){var d,f,h;if(typeof g==
"function"||typeof g=="object"&&g)if(m.call(g)=="[object Function]")f=g;else if(m.call(g)=="[object Array]"){h={};for(var i=0,e=g.length,j;i<e;j=g[i++],(m.call(j)=="[object String]"||m.call(j)=="[object Number]")&&(h[j]=1));}if(c)if(m.call(c)=="[object Number]"){if((c=c-c%1)>0){d="";for(c>10&&(c=10);d.length<c;d=d+" ");}}else m.call(c)=="[object String]"&&(d=c.length<=10?c:c.slice(0,10));return F("",(j={},j[""]=a,j),f,h,d,"",[])};var K=String.fromCharCode,J={"\\":"\\",'"':'"',"/":"/",b:"\u0008",t:"\t",
n:"\n",f:"\u000c",r:"\r"},a,r,q;Kamino.parse=function(b,g){var c,d;a=0;r=""+b;q=[];w&&(r=b.split(""));c=E(l());l()!="$"&&h();a=r=y;return g&&m.call(g)=="[object Function]"?G((d={},d[""]=c,d),"",g):c};Kamino.d=function(a){return Kamino.parse(Kamino.stringify(a))}})(this);
}());